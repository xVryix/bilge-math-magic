...
const planDetails: Record<string, { name: string; price: string; description: string; sessions: string }> = {
  single: { name: "Single Session", price: "$20", description: "One 1-hour tutoring session via Google Meet.", sessions: "1 session" },
  "4-session": { name: "4-Session Bundle", price: "$72", description: "Four 1-hour tutoring sessions via Google Meet. Save $8!", sessions: "4 sessions" },
  "8-session": { name: "8-Session Bundle", price: "$136", description: "Eight 1-hour tutoring sessions via Google Meet. Save $24!", sessions: "8 sessions" },
};
    ...
    <div className="py-20">
      <div className="container mx-auto px-4 max-w-2xl">
        <FadeIn>
          ...
          <p className="mt-3 text-muted-foreground">Fill out the form below and I'll get back to you within 24 hours to confirm your session.</p>
        </FadeIn>
        ...
        <FadeIn delay={0.15}>
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <p className="text-center text-xs text-muted-foreground">Payment details (PayPal or Venmo) will be provided after booking confirmation.</p>
          </form>
        </FadeIn>
      </div>
    </div>
