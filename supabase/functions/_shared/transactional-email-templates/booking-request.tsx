...
const BookingRequestEmail = (props: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>New booking request: {props.planName || 'Session'} from {props.parentName || 'a parent'}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>New Booking Request — {props.planName || 'Session'}</Heading>
        <Text style={text}><strong>Plan:</strong> {props.planName} ({props.planPrice})</Text>
        <Hr style={hr} />
...
export const template = {
  ...
  subject: (data: Record<string, any>) => `Booking request: ${data.planName || 'Session'} from ${data.parentName || 'a parent'}`,
  to: 'mathwithclaritytutors@gmail.com',
  displayName: 'Booking request',
  previewData: { parentName: 'Sarah M.', email: 'sarah@example.com', childName: 'Emma', grade: '5th', interests: 'Drawing, soccer', struggles: 'Fractions', time: 'Tuesdays 6pm', planName: '4-Session Bundle', planPrice: '$72' },
